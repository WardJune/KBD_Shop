            ...
            <div class="col-md-10">
                <div class="container rounded-0 card shadow-none bg-secondary">
                    ...
                    <div class="card-body row">
                        <form class="row col-md-9" action="{{ route('profile.address-update', $addressBook->id) }}"
                            method="post">
                            @csrf
                            @method('patch')
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm rounded-0" id="title" name="title"
                                    value="{{ old('title') ?? $addressBook->title }}" placeholder="Example : Home/Office">
                                @error('title')
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm rounded-0" id="customer_name"
                                    name="customer_name"
                                    value="{{ old('customer_name') ?? $addressBook->customer_name }}">
                                @error('customer_name')
                                    <small class="text-danger mb-2">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <input type="number" name="customer_phone" id="customer_phone"
                                    ...
                                    value="{{ old('customer_phone') ?? $addressBook->customer_phone }}">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" name="customer_address" id="customer_address"
                                    class="form-control form-control-sm rounded-0"
                                    value="{{ old('customer_address') ?? $addressBook->customer_address }}">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select class="form-control form-control-sm rounded-0" name="province_id" id="province_id">
                                    ...
                                    @foreach ($provinces as $province)
                                        <option
                                            {{ $province->id == $addressBook->district->province->id ? 'selected' : '' }}
                                            value="{{ $province->id }}">
                                            {{ $province->name }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select class="form-control form-control-sm rounded-0" name="city_id" id="city_id">
                                    ...
                                    @foreach ($cities as $city)
                                        <option {{ $city->id == $addressBook->district->city->id ? 'selected' : '' }}
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select class="form-control form-control-sm rounded-0" name="district_id" id="district_id">
                                    ...
                                    @foreach ($districts as $district)
                                        <option {{ $district->id == $addressBook->district_id ? 'selected' : '' }}
