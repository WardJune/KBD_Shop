            ...
            <div class="col-md-10">
                <div class="container card rounded-0 shadow-none bg-secondary">
                    <div class="card-header bg-transparent">
                        <span class="h4">Add New Address</span>
                    </div>
                    <div class="card-body row">
                        <form class="row col-md-9" action="{{ route('profile.address-add') }}" method="post">
                            @csrf
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm rounded-0" id="title" name="title"
                                    value="{{ old('title') }}" placeholder="Example : Home/Office">
                                @error('title')
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm rounded-0" id="customer_name"
                                    name="customer_name" value="{{ old('customer_name') }}" placeholder="Full Name">
                                @error('customer_name')
                                    <small class="text-danger mb-2">{{ $message }}</small>
                                @enderror
                            </div>
