                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control mb-1" type="text" name="desc[]" required value="{{$product->desc[0]}}">
                                <input class="form-control mb-1" type="text" name="desc[]" value="{{$product->desc[1]}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-control">
                                    ...
                                    <option value="{{ $row->id }}" {{ old('category_id') || $product->category_id == $row->id ? 'selected':'' }}>
                                        {{ $row->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            {{-- Data pilihan merk --}}
                             <div class="form-group">
                                ...
                                <select name="merk_id" id="merk_id" class="form-control">
                                    <option value='null' {{$product->merk_id == null ? 'selected' : ''}} >none</option>
                                    @foreach ($merk as $val)
                                    <option value="{{$val->id}}" {{old('merk_id') || $product->merk_id == $val->id ? 'selected' : ''}}>{{$val->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input min="0.1" step="0.1" type="number" name="weight" class="form-control" value="{{ old('weight') ?? $product->weight }}"
                                    required>
