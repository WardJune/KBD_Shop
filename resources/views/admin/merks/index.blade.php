                ...
                <div class="table-responsive">
                    <table class="table align-items-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$i++}}</td>
                                <td><img src="{{asset($val->takeImage()) }} " width="100px" height="100px">
                                </td>
                                <td>{{$val->name}}</td>
                                ...
                                <td>
                                    ...
                                    {{-- edit --}}
                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#editModal{{$val->id}}">
                                        Edit
                                    </button>
                                    {{-- delete --}}
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{$val->id}}">
                                        Delete
                                    </button>
                                    {{-- button trigger modal --}}
                                </td>
                            ...
                            <div class="modal fade" id="editModal{{$val->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('merk.update', $val->id)}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('patch')
                                            <div class="modal-body ">
                                                ...
                                                <div class="input-group mb-3 rounded">
                                                    <div class="custom-file">
                                                        <input value="{{$val->image}}" name="image" type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" value="{{ old('image') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('merk.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3 rounded">
                            <div class="custom-file">
                                <input name="image" type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" value="{{ old('image') }}">
